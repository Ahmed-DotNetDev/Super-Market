...
class Super:
    def __init__(self, root):
        ...
        btn_customer = Button(F1, text='بحث', font=('tajawal', 10), width=9, height=3, bg='white', command=self.find)
        ...
        br6 = Label(FF3, text='فرن غا  ', font=('tajawal', 12), bg='#0B4C5F', fg='white')
